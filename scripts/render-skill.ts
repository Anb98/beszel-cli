...
/**
 * Single source of truth for SKILL.md content. Both `gen:skill` (writes the file)
 * and `check:skill` (CI staleness guard) import this so they can never diverge.
 */
...
${mdTable(["Command", "Purpose", "JSON output shape"], commandRows)}
